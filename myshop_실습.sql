...
select customer_name, customer_id, gender, city, phone, point from customer where point >= 50000 and not city = "서울";
...
select customer_name, customer_id, gender, city, phone, point from customer where point between 40000 and 50000;
...
select customer_name, customer_id, gender, city, phone, birth_date, point from customer where birth_date like "1990%" and gender = "M";
